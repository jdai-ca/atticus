...
export interface Translations {
  ...
  harmWarningRiskLevelLabel: string;
  harmWarningRiskLevelCritical: string;
  harmWarningRiskLevelHigh: string;
  harmWarningRiskLevelCompliance: string;
  harmWarningAdviceLabel: string;
  ...
  // Settings - Safety (SRAIS)
  settingsSafety: {
    safetyConfiguration: string;
    safetyScanningDescription: string;
    riskStratificationTitle: string;
    riskStratificationDescription: string;
    hilDesignTitle: string;
    hilDesignDescription: string;
    deobfuscationHeuristicTitle: string;
    ...
    complianceRiskDescription: string;
  };
...
const settingsContentEn = {
  ...
  both: '🔄 Both',
  configureModelNote:
    'Configure each model for practice areas (legal), advisory areas (business consulting), or both. This allows you to optimize specific models for their strengths.',
  ...
  practiceAreasDetection:
    'Atticus automatically detects the practice area based on your conversation content. Here are the configured practice areas:',
  ...
  coversLegalDomains:
    '• Covers corporate law, IP, employment, contracts, compliance, privacy, and more',
  advisoryCapabilities:
    'Atticus provides comprehensive business advisory capabilities to complement legal services. The system automatically detects advisory topics and adjusts guidance accordingly.',
  ...
  coversAdvisoryDomains:
    '• Covers strategy, finance, marketing, operations, HR, technology, risk, sustainability, and M&A',
  ...
  configureAnalysisPrompt:
    'Configure the system prompt used for multi-model response validation and analysis. This prompt guides the AI quality analyst when comparing responses from different models.',
  analysisSystemPrompt: 'Analysis System Prompt',
  definesAnalysis:
    'Defines how AI models analyze and compare responses for consistency, accuracy, and quality.',
  currentConfiguration: 'Current Configuration',
  sourceAnalysisYaml: 'Source: analysis.yaml',
  configuredPromptInfo: '[Configured system prompt for response analysis]',
  usedWhen:
    'Used when: User clicks "Analyze Response Cluster" to compare multiple AI responses using an independent model.',
  whatIsResponseAnalysis: '💡 What is Response Analysis?',
  responseAnalysisExplanation:
    'When you receive responses from multiple AI models, you can use an independent "judge" model to analyze and compare them. The analysis system prompt guides this judge model to evaluate consistency, accuracy, completeness, and quality of the responses.',
  ...
  customizationExplanation:
    'The analysis prompt can be customized to emphasize specific criteria relevant to your use case (e.g., legal accuracy, technical precision, business viability). Click "Customize" to edit the system prompt in a structured editor.',
  ...
  globalCoverageDescription:
    'Atticus provides specialized support for startups and businesses operating in:',
  ...
  startupOptimization:
    'With 90% optimization for startup and entrepreneurship needs, Atticus covers the entire startup lifecycle:',
  ...
  apiCallsDirectNoIntermed:
    '✓ API calls made directly to your chosen providers - no intermediaries',
  lockedSafetyScanner: '✓ Locked-in Safety Scanner (SRAIS + PII Guardrails always active)',
  ...
  piiScanningDescription:
    'PII (Personally Identifiable Information) scanning to help protect your sensitive data before sending it to AI providers.',
  alwaysEnabled: 'ALWAYS ENABLED',
  automaticallyScans:
    'Automatically scans your messages for sensitive information like SSN, credit cards, emails, phone numbers, and more before sending to AI providers.',
  legalProtectionFull:
    "Legal Protection: PII scanning cannot be disabled. This mandatory security feature protects both you and Atticus from liability by ensuring you're always warned before sharing sensitive data.",
  ...
  patternsNote:
    'Note: The above are representative examples. The scanner uses {count} total patterns covering variations and additional formats.',
  patterns: 'Patterns',
  ...
  reviewProviderPolicies:
    '✓ Each AI provider has different privacy policies - review them carefully',
  ...
  editInstructions:
    'Edit the analysis system prompt below. This prompt guides the AI quality analyst when comparing responses from different models.',
  analysisPromptLabel: 'Analysis System Prompt',
  characterCount: 'characters',
  yamlEditInstructions:
  ...
  systemPromptHelp:
    "This prompt defines the AI's expertise, approach, and guidelines when responding to queries in this area.",
  keywords: 'Keywords',
  ...
  azureResourceNamePlaceholder:
    'Just the resource name from your Azure OpenAI URL (e.g., "my-openai-resource")',
...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    // Footer
    disclaimer:
      'Atticus is an AI assistant. Always consult with a licensed attorney for legal advice.',
    ...
    harmWarningCautionBody:
      'Your message contains topics related to financial, legal, or other sensitive business risks. Proceeding will send this content to your selected AI provider.',
    ...
    harmWarningRiskLevelLabel: 'SRAIS Risk Level:',
    harmWarningRiskLevelCritical: 'Critical Risk',
    harmWarningRiskLevelHigh: 'High-Stakes/Severe Risk',
    harmWarningRiskLevelCompliance: 'Compliance Risk',
    harmWarningAdviceLabel: 'SRAI Guidance & Action Recommendation:',
    ...
    settingsProviders: {
      ...
      introText:
        'Configure AI providers to enable Atticus. You can add multiple providers and switch between them.',
      update: 'Update',
      activate: 'Activate',
    ...
    settingsAreas: {
      ...
      systemPromptPlaceholder:
        'Enter the system prompt that will guide AI responses for this area...',
      editYaml: 'Edit YAML',
    ...
    settingsAnalysis: {
      ...
      usedWhen:
        'Used when: User clicks "Analyze Response Cluster" to compare multiple AI responses',
      resetComplete: 'Configuration has been reset to factory defaults',
      whatIsResponseAnalysis: '💡 What is Response Analysis?',
      responseAnalysisDescription:
        'When you receive responses from multiple AI models, you can use an independent "judge" model to analyze and compare them. The analysis system prompt guides this judge model to evaluate consistency, accuracy, completeness, and quality of the responses.',
      keyAnalysisCriteria: 'Key Analysis Criteria',
    ...
    // Settings - Safety (SRAIS)
    settingsSafety: {
      safetyConfiguration: 'Safe and Responsible AI Implementation (SRAI) Safety Heuristics',
      safetyScanningDescription:
        'SRAIS handles the protection and safety scoring for modern AI legal frameworks prior to provider queries.',
      riskStratificationTitle: '🔢 Risk Stratification & Dynamic Scoring',
      riskStratificationDescription:
        'SRAIS classifies your query into four risk categories: Critical, High-Stakes, Compliance, or Low. Depending on the highest detected category, safety actions or warnings are adjusted in real-time.',
      hilDesignTitle: '👥 Human-In-The-Loop Advisory System',
      hilDesignDescription:
        'By design, no automated decisions are taken. Warnings recommend explicit oversight routes, such as consulting certified counsel or authorized administrative agencies.',
      deobfuscationHeuristicTitle: '🔡 Adversarial De-obfuscation Pipeline',
      deobfuscationHeuristicDescription:
        'SRAIS includes self-decrypting layers to intercept encoding tricks (Base64, Hex, URL, or ROT13) designed to bypass vocabulary analysis.',
      ...
      highRiskDescription:
        'Targets litigation proceedings, direct intellectual property infringement, or commercial liability. Suggests licensed attorney involvement.',
      complianceRiskDescription:
        'Triggers on corporate tax reviews, audits, data alignment checks, or standard internal company procedures.',
    },
    ...
    privacyDialog: {
      ...
      piiDetectedMessage:
        'Personally Identifiable Information (PII) has been detected in your message',
  ...
  fr: {
    ...
    // Footer
    disclaimer:
      'Atticus est un assistant IA. Consultez toujours un avocat agréé pour des conseils juridiques.',
    ...
    harmWarningDescription:
      'L’analyse SRAIS a détecté un langage commercial ou juridique potentiellement dangereux.',
    harmWarningCaution: 'Prudence recommandée',
    harmWarningCautionBody:
      'Votre message contient des sujets liés aux risques financiers, juridiques ou à d’autres risques commerciaux sensibles. Continuer enverra ce contenu à votre fournisseur d’IA sélectionné.',
    harmWarningTargetLabel: 'Cible :',
    harmWarningConsequencesLabel: 'Conséquences :',
    harmWarningOriginalTextLabel:
      'L’extrait de texte original correspond à une terminologie à risque.',
    harmWarningCancel: 'Annuler',
    harmWarningProceed: 'Envoyer quand même',
    harmWarningBadgeLabel: 'Risques potentiels détectés',
    harmWarningRiskLevelLabel: 'Niveau de risque SRAIS :',
    harmWarningRiskLevelCritical: 'Risque critique',
    harmWarningRiskLevelHigh: 'Risque élevé / Grave',
    harmWarningRiskLevelCompliance: 'Risque de conformité',
    harmWarningAdviceLabel: 'Directive SRAI et recommandations d’action :',
    ...
    settingsProviders: {
      ...
      introText:
        "Configurez les fournisseurs d'IA pour activer Atticus. Vous pouvez ajouter plusieurs fournisseurs et basculer entre eux.",
      update: 'Mettre à Jour',
      activate: 'Activer',
      removeApiKey:
        'Supprimer la clé API pour {provider}? Cela supprimera la configuration du fournisseur.',
    ...
    settingsAreas: {
      ...
      systemPromptPlaceholder:
        "Entrez l'invite système qui guidera les réponses IA pour ce domaine...",
    ...
    settingsAnalysis: {
      ...
      usedWhen:
        'Utilisé quand: L\'utilisateur clique sur "Analyser le Groupe de Réponses" pour comparer plusieurs réponses IA',
      ...
      responseAnalysisDescription:
        "Lorsque vous recevez des réponses de plusieurs modèles IA, vous pouvez utiliser un modèle \"juge\" indépendant pour les analyser et les comparer. L'invite système d'analyse guide ce modèle juge pour évaluer la cohérence, la précision, l'exhaustivité et la qualité des réponses.",
      ...
      customizationDescription:
        "L'invite d'analyse peut être personnalisée pour mettre l'accent sur des critères spécifiques pertinents pour votre cas d'usage (par exemple, précision juridique, précision technique, viabilité commerciale). Cliquez sur \"Personnaliser\" pour éditer l'invite système dans un éditeur structuré.",
      critical: 'Critique',
    },
    ...
    // Settings - Safety (SRAIS)
    settingsSafety: {
      safetyConfiguration: 'Règles de sécurité SRAI (Safe and Responsible AI Implementation)',
      safetyScanningDescription:
        'SRAIS gère la protection et l’évaluation de la sécurité pour les cadres juridiques d’IA avant d’interroger les fournisseurs d’IA.',
      riskStratificationTitle: '🔢 Évaluation et notation dynamique des risques',
      riskStratificationDescription:
        'SRAIS classe votre requête en quatre niveaux de risque : Critique, Élevé, Conformité, ou Faible. Selon le cas, les avertissements s’adaptent en temps réel.',
      hilDesignTitle: '👥 Système consultatif avec intervention humaine',
      hilDesignDescription:
        'Par conception, aucune décision n’est automatisée. Les avertissements suggèrent des étapes de supervision, comme la consultation d’un avocat agréé.',
      deobfuscationHeuristicTitle: '🔡 Pipeline de désobfuscation contradictoire',
      deobfuscationHeuristicDescription:
        'SRAIS comprend des mécanismes de décryptage local pour intercepter les ruses de contournement (Base64, Hex, URL, ou ROT13).',
      ...
      highRiskDescription:
        'Vise les procédures de litige, l’atteinte directe à la propriété intellectuelle ou la responsabilité commerciale. Suggère la consultation d’un avocat agréé.',
      complianceRiskDescription:
        'Se déclenche lors de contrôles fiscaux, d’audits, d’alignements de données ou de procédures internes d’entreprise habituelles.',
    },
    ...
    privacyDialog: {
      ...
      piiDetectedMessage:
        'Des Informations Personnelles Identifiables (PII) ont été détectées dans votre message',
    ...
    settingsContent: {
      ...
      both: '🔄 Les deux',
      configureModelNote:
        "Configurez chaque modèle pour les domaines de pratique (juridique), les domaines de conseil (conseil d'entreprise), ou les deux. Cela vous permet d'optimiser des modèles spécifiques pour leurs forces.",
      viewTemplates: 'Voir les Modèles de Fournisseurs Disponibles',
      addProvider: 'Ajouter un Nouveau Fournisseur IA',
      needHelp: "Besoin d'Aide?",
      apiKeysStoredSecurely:
        '• Vos clés API sont stockées en toute sécurité sur votre machine locale',
      configureMultipleProviders:
        '• Vous pouvez configurer plusieurs fournisseurs et basculer entre eux',
      apiCallsDirect:
        "• Tous les appels API sont effectués directement aux fournisseurs - pas d'intermédiaires",
      incurCostsDirectly:
        "• Vous engagez des coûts directement avec chaque fournisseur en fonction de l'utilisation",
      configured: '✓ Configuré',
      active: 'Actif',
      defaultModel: 'Modèle par Défaut',
      availableModels:
        "Modèles Disponibles (cocher pour activer, sélectionner l'utilisation du domaine)",
      ...
      confirmResetFactory:
        "Êtes-vous sûr de vouloir réinitialiser la configuration {type} aux paramètres d'usine?\\n\\nCela écrasera toutes les personnalisations que vous avez apportées.",
      practiceAreasDetection:
        'Atticus détecte automatiquement le domaine de pratique en fonction du contenu de votre conversation. Voici les domaines de pratique configurés:',
      ...
      automaticAreaDetection:
        '• Détection automatique du domaine et conseils juridiques contextuels',
      coversLegalDomains:
        '• Couvre le droit des sociétés, la propriété intellectuelle, le droit du travail, les contrats, la conformité, la vie privée, et plus encore',
      advisoryCapabilities:
        "Atticus fournit des capacités de conseil d'entreprise complètes pour compléter les services juridiques. Le système détecte automatiquement les sujets de conseil et ajuste les conseils en conséquence.",
      ...
      coversAdvisoryDomains:
        '• Couvre la stratégie, les finances, le marketing, les opérations, les RH, la technologie, les risques, la durabilité et les fusions-acquisitions',
      complementsLegalAreas:
        '• Complète les domaines de pratique juridique pour un soutien commercial complet',
      updateAvailable: 'Mise à Jour Disponible',
      dismiss: 'Ignorer',
      responseAnalysisConfig: "🔍 Configuration de l'Analyse des Réponses",
      configureAnalysisPrompt:
        "Configurez l'invite système utilisée pour la validation et l'analyse des réponses multi-modèles. Cette invite guide l'analyste qualité IA lors de la comparaison des réponses de différents modèles.",
      analysisSystemPrompt: "Invite Système d'Analyse",
      definesAnalysis:
        'Définit comment les modèles IA analysent et comparent les réponses pour la cohérence, la précision et la qualité.',
      currentConfiguration: 'Configuration Actuelle',
      sourceAnalysisYaml: 'Source: analysis.yaml',
      configuredPromptInfo: "[Invite système configurée pour l'analyse des réponses]",
      usedWhen:
        "Utilisé quand: L'utilisateur clique sur \"Analyser le Cluster de Réponses\" pour comparer plusieurs réponses IA à l'aide d'un modèle indépendant.",
      whatIsResponseAnalysis: "💡 Qu'est-ce que l'Analyse des Réponses?",
      responseAnalysisExplanation:
        "Lorsque vous recevez des réponses de plusieurs modèles IA, vous pouvez utiliser un modèle \"juge\" indépendant pour les analyser et les comparer. L'invite système d'analyse guide ce modèle juge pour évaluer la cohérence, la précision, l'exhaustivité et la qualité des réponses.",
      keyAnalysisCriteria: "Critères d'Analyse Clés",
      ...
      accuracyCheck:
        '2. Précision: Identifier les inexactitudes potentielles ou les confabulations',
      completenessCheck: '3. Exhaustivité: Quels points importants manquent?',
      qualityRankingCheck:
        '4. Classement de Qualité: Classer les réponses de la meilleure à la pire',
      recommendationsCheck: '5. Recommandations: Quelle(s) réponse(s) faire le plus confiance',
      customizationNote: '⚠️ Note de Personnalisation',
      customizationExplanation:
        "L'invite d'analyse peut être personnalisée pour mettre l'accent sur des critères spécifiques pertinents pour votre cas d'utilisation (par exemple, précision juridique, précision technique, viabilité commerciale). Cliquez sur \"Personnaliser\" pour modifier l'invite système dans un éditeur structuré.",
      ...
      startupOptimization:
        "Avec 90% d'optimisation pour les besoins en startup et entrepreneuriat, Atticus couvre l'ensemble du cycle de vie des startups:",
      ...
      allDataLocal:
        '✓ Toutes les données stockées localement sur votre machine - pas de stockage cloud',
      apiCallsDirectNoIntermed:
        "✓ Appels API effectués directement à vos fournisseurs choisis - pas d'intermédiaires",
      lockedSafetyScanner: '✓ Système de sécurité intégré (les barrières SRAIS + PII sont actives)',
      fullDataControl:
        '✓ Contrôle total sur vos données et conversations (y compris les dépenses API)',
      importantDisclaimer: '⚠️ Avertissement Important',
      disclaimerText:
        "Atticus est un assistant alimenté par IA conçu pour fournir des informations et des conseils généraux. Il ne fournit pas de conseils juridiques, et ses résultats ne doivent pas être considérés comme un substitut à une consultation avec des professionnels juridiques ou commerciaux qualifiés. Consultez toujours des avocats, des comptables ou d'autres conseillers qualifiés pour des questions juridiques, fiscales ou commerciales spécifiques affectant votre situation.",
      ...
      piiScanningDescription:
        'Analyse des PII (Informations Personnellement Identifiables) pour aider à protéger vos données sensibles avant de les envoyer aux fournisseurs IA.',
      alwaysEnabled: 'TOUJOURS ACTIVÉ',
      automaticallyScans:
        'Analyse automatiquement vos messages pour des informations sensibles telles que le numéro de sécurité sociale, les cartes de crédit, les e-mails, les numéros de téléphone, et plus encore avant de les envoyer aux fournisseurs IA.',
      legalProtectionFull:
        "Protection Juridique: L'analyse des PII ne peut pas être désactivée. Cette fonctionnalité de sécurité obligatoire vous protège, vous et Atticus, de toute responsabilité en veillant à ce que vous soyez toujours averti avant de partager des données sensibles.",
      ...
      examplesOfSensitiveData:
        'Exemples de modèles de données sensibles qui sont automatiquement analysés:',
      ...
      patternsNote:
        'Note: Les éléments ci-dessus sont des exemples représentatifs. Le scanner utilise {count} modèles au total couvrant les variations et les formats supplémentaires.',
      patterns: 'Modèles',
      importantPrivacyInfoTitle: 'ℹ️ Informations Importantes sur la Confidentialité',
      detectionLocal:
        "✓ Toute détection de PII se produit localement sur votre appareil - aucune donnée envoyée à l'extérieur",
      scannerWarningsOnly:
        "✓ Le scanner fournit des avertissements mais ne peut pas vous empêcher d'envoyer des données",
      userResponsibility:
        '✓ Vous êtes finalement responsable de la protection des informations confidentielles',
      reviewProviderPolicies:
        '✓ Chaque fournisseur IA a des politiques de confidentialité différentes - examinez-les attentivement',
      useExampleData:
        "✓ Envisagez d'utiliser des données d'exemple ou d'anonymiser les détails pour les requêtes sensibles",
      noDataCollection:
        "✓ Les développeurs d'Atticus ne collectent, ne stockent ni n'ont accès à vos données",
      editConfiguration: 'Modifier la Configuration',
      editAnalysisPrompt: "Modifier l'Invite d'Analyse",
      editInstructions:
        "Modifiez l'invite système d'analyse ci-dessous. Cette invite guide l'analyste qualité IA lors de la comparaison des réponses de différents modèles.",
      analysisPromptLabel: "Invite Système d'Analyse",
      characterCount: 'caractères',
      yamlEditInstructions:
        "Modifiez la configuration ci-dessous. Les modifications prendront effet après le redémarrage d'Atticus.",
      ...
      systemPrompt: 'Invite Système',
      systemPromptHelp:
        "Cette invite définit l'expertise, l'approche et les directives de l'IA lors de la réponse aux requêtes dans ce domaine.",
      keywords: 'Mots-Clés',
  ...
  es: {
    ...
    // Footer
    disclaimer:
      'Atticus es un asistente de IA. Siempre consulte con un abogado autorizado para asesoramiento legal.',
    ...
    harmWarningDescription:
      'El análisis SRAIS detectó lenguaje comercial o legal potencialmente dañino.',
    harmWarningCaution: 'Se recomienda precaución',
    harmWarningCautionBody:
      'Su mensaje contiene temas relacionados con riesgos financieros, legales u otros riesgos comerciales sensibles. Continuar enviará este contenido a su proveedor de IA seleccionado.',
    harmWarningTargetLabel: 'Objetivo:',
    harmWarningConsequencesLabel: 'Consecuencias:',
    harmWarningOriginalTextLabel:
      'El fragmento de texto original coincide con terminología de riesgo.',
    harmWarningCancel: 'Cancelar',
    harmWarningProceed: 'Enviar de todos modos',
    harmWarningBadgeLabel: 'Daños potenciales detectados',
    harmWarningRiskLevelLabel: 'Nivel de riesgo SRAIS:',
    harmWarningRiskLevelCritical: 'Riesgo crítico',
    harmWarningRiskLevelHigh: 'Riesgo severo / Alto',
    harmWarningRiskLevelCompliance: 'Riesgo de cumplimiento',
    harmWarningAdviceLabel: 'Guía de SRAI y recomendaciones de acción:',
    ...
    settingsProviders: {
      ...
      introText:
        'Configure proveedores de IA para habilitar Atticus. Puede agregar múltiples proveedores y cambiar entre ellos.',
      update: 'Actualizar',
      activate: 'Activar',
      removeApiKey:
        '¿Eliminar clave API para {provider}? Esto eliminará la configuración del proveedor.',
    ...
    settingsAreas: {
      ...
      systemPromptPlaceholder:
        'Ingrese la indicación del sistema que guiará las respuestas de IA para esta área...',
    ...
    settingsAnalysis: {
      ...
      systemPromptPlaceholder:
        'Ingrese la indicación del sistema para el análisis de respuestas...',
      emptyPromptError: 'La indicación del sistema de análisis no puede estar vacía',
      usedWhen:
        'Se usa cuando: El usuario hace clic en "Analizar Grupo de Respuestas" para comparar múltiples respuestas de IA',
      ...
      responseAnalysisDescription:
        'Cuando recibe respuestas de múltiples modelos de IA, puede usar un modelo "juez" independiente para analizarlas y compararlas. La indicación del sistema de análisis guía a este modelo juez para evaluar la consistencia, precisión, completitud y calidad de las respuestas.',
      ...
      customizationDescription:
        'La indicación de análisis se puede personalizar para enfatizar criterios específicos relevantes para su caso de uso (por ejemplo, precisión legal, precisión técnica, viabilidad comercial). Haga clic en "Personalizar" para editar la indicación del sistema en un editor estructurado.',
      critical: 'Crítico',
    },
    ...
    settingsSafety: {
      safetyConfiguration:
        'Métodos y Heurísticas de seguridad SRAI (Seguridad y Responsabilidad de la IA)',
      safetyScanningDescription:
        'SRAIS se encarga de proteger las consultas de IA y clasificarlas según directrices éticas y legales antes del envío a los proveedores.',
      riskStratificationTitle: '🔢 Clasificación y evaluación dinámica de riesgos',
      riskStratificationDescription:
        'SRAIS clasifica de forma instantánea cualquier solicitud en cuatro niveles de riesgo: Crítico, Alto Riesgo, Cumplimiento, o Bajo Riesgo. Las alertas se ajustan dinámicamente.',
      hilDesignTitle: '👥 Sistema consultivo con intervención humana (HIL)',
      hilDesignDescription:
        'Por diseño autónomo, no se delega ninguna decisión vinculante en la IA. Las alertas sugieren explícitamente consultar a abogados certificados o a canales internos de auditoría.',
      deobfuscationHeuristicTitle: '🔡 Tubería de desofuscación adversarial',
      deobfuscationHeuristicDescription:
        'SRAIS incluye capas automáticas de descifrado local para evadir trucos de enmascaramiento con Base64, Hex, URL, o cifrado ROT13.',
      sraisGuardrailsLabel: 'Garde-fous SRAIS',
      sraisGuardrailsDescription:
      ...
      highRiskDescription:
        'Se dirige a procedimientos de litigios, infracciones directas de propiedad intelectual o responsabilidad comercial. Sugiere la participación de un abogado calificado.',
      complianceRiskDescription:
        'Se activa en revisiones fiscales de la empresa, auditorías corporativas, controles de alineación de datos o procedimientos corporativos estándar.',
    },
    ...
    settingsContent: {
      ...
      both: '🔄 Ambos',
      configureModelNote:
        'Configure cada modelo para áreas de práctica (legal), áreas de asesoramiento (consultoría empresarial), o ambas. Esto le permite optimizar modelos específicos según sus fortalezas.',
      ...
      apiCallsDirect:
        '• Todas las llamadas API se realizan directamente a los proveedores - sin intermediarios',
      ...
      confirmResetFactory:
        '¿Está seguro de que desea restablecer la configuración {type} a los valores de fábrica?\\n\\nEsto sobrescribirá todas las personalizaciones que haya realizado.',
      practiceAreasDetection:
        'Atticus detecta automáticamente el área de práctica según el contenido de su conversación. Aquí están las áreas de práctica configuradas:',
      ...
      coversLegalDomains:
        '• Cubre derecho corporativo, propiedad intelectual, derecho laboral, contratos, cumplimiento, privacidad, y más',
      advisoryCapabilities:
        'Atticus proporciona capacidades integrales de asesoramiento empresarial para complementar los servicios legales. El sistema detecta automáticamente los temas de asesoramiento y ajusta la orientación en consecuencia.',
      ...
      coversAdvisoryDomains:
        '• Cubre estrategia, finanzas, marketing, operaciones, RRHH, tecnología, riesgos, sostenibilidad y fusiones y adquisiciones',
      complementsLegalAreas:
        '• Complementa las áreas de práctica legal para un soporte empresarial integral',
      updateAvailable: 'Actualización Disponible',
      dismiss: 'Descartar',
      responseAnalysisConfig: '🔍 Configuración del Análisis de Respuestas',
      configureAnalysisPrompt:
        'Configure la instrucción del sistema utilizada para la validación y análisis de respuestas de múltiples modelos. Esta instrucción guía al analista de calidad de IA al comparar respuestas de diferentes modelos.',
      analysisSystemPrompt: 'Instrucción del Sistema de Análisis',
      definesAnalysis:
        'Define cómo los modelos de IA analizan y comparan respuestas en términos de coherencia, precisión y calidad.',
      ...
      usedWhen:
        'Usado cuando: El usuario hace clic en "Analizar Grupo de Respuestas" para comparar múltiples respuestas de IA usando un modelo independiente.',
      whatIsResponseAnalysis: '💡 ¿Qué es el Análisis de Respuestas?',
      responseAnalysisExplanation:
        'Cuando recibe respuestas de múltiples modelos de IA, puede usar un modelo "juez" independiente para analizarlas y compararlas. La instrucción del sistema de análisis guía a este modelo juez para evaluar la coherencia, precisión, completitud y calidad de las respuestas.',
      keyAnalysisCriteria: 'Criterios Clave de Análisis',
      ...
      customizationNote: '⚠️ Nota de Personalización',
      customizationExplanation:
        'La instrucción de análisis puede personalizarse para enfatizar criterios específicos relevantes para su caso de uso (por ejemplo, precisión legal, precisión técnica, viabilidad empresarial). Haga clic en "Personalizar" para editar la instrucción del sistema en un editor estructurado.',
      ...
      globalCoverageDescription:
        'Atticus proporciona soporte especializado para startups y empresas que operan en:',
      ...
      startupOptimization:
        'Con 90% de optimización para necesidades de startup y emprendimiento, Atticus cubre todo el ciclo de vida de las startups:',
      ...
      allDataLocal:
        '✓ Todos los datos almacenados localmente en su máquina - sin almacenamiento en la nube',
      apiCallsDirectNoIntermed:
        '✓ Llamadas API realizadas directamente a sus proveedores elegidos - sin intermediarios',
      lockedSafetyScanner:
        '✓ Sistema de seguridad integrado (las salvaguardas SRAIS + PII siempre activas)',
      fullDataControl:
        '✓ Control total sobre sus datos y conversaciones (incluidos los gastos de API)',
      importantDisclaimer: '⚠️ Descargo de Responsabilidad Importante',
      disclaimerText:
        'Atticus es un asistente impulsado por IA diseñado para proporcionar información y orientación general. No proporciona asesoramiento legal, y sus resultados no deben considerarse como un sustituto de la consulta con profesionales legales o comerciales calificados. Siempre consulte con abogados, contadores u otros asesores calificados para asuntos legales, fiscales o comerciales específicos que afecten su situación.',
      ...
      piiScanningDescription:
        'Escaneo de PII (Información de Identificación Personal) para ayudar a proteger sus datos sensibles antes de enviarlos a proveedores de IA.',
      alwaysEnabled: 'SIEMPRE HABILITADO',
      automaticallyScans:
        'Escanea automáticamente sus mensajes en busca de información sensible como números de seguro social, tarjetas de crédito, correos electrónicos, números de teléfono y más antes de enviarlos a proveedores de IA.',
      legalProtectionFull:
        'Protección Legal: El escaneo de PII no se puede deshabilitar. Esta característica de seguridad obligatoria lo protege a usted y a Atticus de responsabilidad al garantizar que siempre se le advierta antes de compartir datos sensibles.',
      ...
      examplesOfSensitiveData:
        'Ejemplos de patrones de datos sensibles que se escanean automáticamente:',
      ...
      patternsNote:
        'Nota: Los anteriores son ejemplos representativos. El escáner utiliza {count} patrones totales que cubren variaciones y formatos adicionales.',
      patterns: 'Patrones',
      importantPrivacyInfoTitle: 'ℹ️ Información Importante sobre Privacidad',
      detectionLocal:
        '✓ Toda la detección de PII ocurre localmente en su dispositivo - no se envían datos externamente',
      scannerWarningsOnly:
        '✓ El escáner proporciona advertencias pero no puede evitar que envíe datos',
      userResponsibility:
        '✓ Usted es en última instancia responsable de proteger la información confidencial',
      reviewProviderPolicies:
        '✓ Cada proveedor de IA tiene diferentes políticas de privacidad - revíselas cuidadosamente',
      useExampleData:
        '✓ Considere usar datos de ejemplo o anonimizar detalles para consultas sensibles',
      noDataCollection:
        '✓ Los desarrolladores de Atticus nunca recopilan, almacenan ni tienen acceso a sus datos',
      editConfiguration: 'Editar Configuración',
      editAnalysisPrompt: 'Editar Instrucción de Análisis',
      editInstructions:
        'Edite la instrucción del sistema de análisis a continuación. Esta instrucción guía al analista de calidad de IA al comparar respuestas de diferentes modelos.',
      analysisPromptLabel: 'Instrucción del Sistema de Análisis',
      characterCount: 'caracteres',
      yamlEditInstructions:
        'Edite la configuración a continuación. Los cambios tendrán efecto después de reiniciar Atticus.',
      ...
      systemPromptHelp:
        'Esta instrucción define la experiencia, el enfoque y las directrices de la IA al responder a consultas en esta área.',
      keywords: 'Palabras Clave',
