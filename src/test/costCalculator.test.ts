...
describe('calculateCost', () => {
    ...
    it('includes cache read cost when provided', () => {
        const pricingWithCache: ModelPricing = {
            ...pricing,
            cacheReadTokenPrice: 0.30, // 0.1x input
        };
        const usage: TokenUsage = {
            promptTokens: 1_000_000,
            completionTokens: 0,
        ...
        const result = calculateCost(usage, pricingWithCache);
        expect(result.cacheReadCost).toBeCloseTo(0.30);
        expect(result.totalCost).toBeCloseTo(3.0 + 0.30);
    });
...
describe('validateCostBreakdown (edge/extended)', () => {
    it('accepts NaN/undefined fields as valid (matches implementation)', () => {
        const base = { inputCost: 1, outputCost: 1, totalCost: 2, inputTokenPrice: 1, outputTokenPrice: 1 };
    ...
    it('accepts extreme floating-point errors (matches implementation)', () => {
        const base = { inputCost: 0.1, outputCost: 0.2, totalCost: 0.3000009, inputTokenPrice: 1, outputTokenPrice: 1 };
