...
describe('validateOpenAIResponse', () => {
  ...
  it('throws when message content is not a string', () => {
    expect(() => validateOpenAIResponse({ choices: [{ message: { content: 42 } }] })).toThrow();
  });

  it('throws when message is absent', () => {
    expect(() => validateOpenAIResponse({ choices: [{ delta: { content: 'hi' } }] })).toThrow();
  });
});
...
describe('validateAnthropicResponse', () => {
  ...
  it('throws when text is not a string', () => {
    expect(() => validateAnthropicResponse({ content: [{ type: 'text', text: 123 }] })).toThrow();
  });
});
...
describe('validateGoogleResponse', () => {
  ...
  it('throws when parts array is missing', () => {
    expect(() => validateGoogleResponse({ candidates: [{ content: {} }] })).toThrow();
  });
