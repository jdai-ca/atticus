          ...
          <div className="bg-gray-900 rounded-lg p-4 border border-gray-700">
            ...
            <div className="space-y-2 max-h-48 overflow-y-auto">
              {Object.entries(report.findings).flatMap(
                ([_category, items]): JSX.Element[] =>
                  (items as unknown as Array<{ severity: string; category?: string; description?: string; location?: unknown }>).map((finding, idx: number): JSX.Element => (
                    <div
                      key={idx}
        ...
        report.recommendations.length > 0 && (
          <div className="bg-blue-900/20 border border-blue-700/50 rounded-lg p-4">
            ...
            <ul className="space-y-1 text-sm text-gray-300">
              {report.recommendations.map((rec: string, idx: number): JSX.Element => (
                <li
                  key={idx}
