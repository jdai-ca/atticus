...
interface ChatThreadConfigSectionProps {
  ...
  readonly selectedModelKeys: React.ComponentProps<typeof ChatThreadConfigBar>['selectedModelKeys'];
  readonly config: React.ComponentProps<typeof ChatThreadConfigBar>['config'];
  readonly providerTemplates: React.ComponentProps<typeof ChatThreadConfigBar>['providerTemplates'];
  readonly selectedJurisdictions: React.ComponentProps<
    typeof ChatThreadConfigBar
  >['selectedJurisdictions'];
  readonly onShowAuditLog: React.ComponentProps<typeof ChatThreadConfigBar>['onShowAuditLog'];
  readonly onShowCostLedger: React.ComponentProps<typeof ChatThreadConfigBar>['onShowCostLedger'];
  ...
  >['showConfigDialog'];
  readonly currentDomain: React.ComponentProps<typeof ChatThreadConfigDialog>['currentDomain'];
  ...
  readonly toggleJurisdiction: React.ComponentProps<
    typeof ChatThreadConfigDialog
  >['toggleJurisdiction'];
  readonly onCloseConfigDialog: React.ComponentProps<typeof ChatThreadConfigDialog>['onClose'];
}
