  ...
  return (
    <div>
      ...
      <div className="bg-gray-900 rounded-lg p-6 border border-gray-700 mb-6">
        ...
        <p className="text-gray-300 mb-4">{t.settingsContent.configureAnalysisPrompt}</p>
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">{t.settingsContent.definesAnalysis}</p>
          </div>
        ...
        <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
          ...
          <p className="text-xs text-gray-400 mb-3">{t.settingsContent.sourceAnalysisYaml}</p>
...
multiple AI responses using an independent model.`}
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
            ...
            <ul className="text-xs text-gray-300 space-y-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>{t.settingsAdditional.recommendations}</strong>{' '}
          ...
          <div className="bg-yellow-900/20 rounded-lg p-4 border border-yellow-700/50">
            ...
            <p className="text-xs text-gray-300">{t.settingsAnalysis.customizationDescription}</p>
          </div>
        </div>
      </div>
    </div>
