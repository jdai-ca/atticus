...
interface ChatDialogsSectionProps {
  readonly showPrivacyWarning: React.ComponentProps<typeof ChatSystemDialogs>['showPrivacyWarning'];
  readonly piiScanResult: React.ComponentProps<typeof ChatSystemDialogs>['piiScanResult'];
  readonly onPrivacyProceed: React.ComponentProps<typeof ChatSystemDialogs>['onPrivacyProceed'];
  readonly onPrivacyCancel: React.ComponentProps<typeof ChatSystemDialogs>['onPrivacyCancel'];
  readonly onPrivacyAnonymize: React.ComponentProps<typeof ChatSystemDialogs>['onPrivacyAnonymize'];
  readonly showHarmWarning: React.ComponentProps<typeof ChatSystemDialogs>['showHarmWarning'];
  readonly sraisScanResult: React.ComponentProps<typeof ChatSystemDialogs>['sraisScanResult'];
  readonly onHarmProceed: React.ComponentProps<typeof ChatSystemDialogs>['onHarmProceed'];
  readonly onHarmCancel: React.ComponentProps<typeof ChatSystemDialogs>['onHarmCancel'];
  ...
  readonly inspectedApiTrace: React.ComponentProps<typeof ChatSystemDialogs>['inspectedApiTrace'];
  readonly currentConversation: React.ComponentProps<
    typeof ChatSystemDialogs
  >['currentConversation'];
  readonly onCloseAuditLog: React.ComponentProps<typeof ChatSystemDialogs>['onCloseAuditLog'];
  readonly onCloseCostLedger: React.ComponentProps<typeof ChatSystemDialogs>['onCloseCostLedger'];
  ...
  readonly tagDialogClusterEnd: React.ComponentProps<typeof ChatTagDialog>['tagDialogClusterEnd'];
  ...
  readonly onNewTagInputChange: React.ComponentProps<typeof ChatTagDialog>['onNewTagInputChange'];
  ...
  readonly selectModelLabel: React.ComponentProps<typeof ChatAnalysisDialog>['selectModelLabel'];
